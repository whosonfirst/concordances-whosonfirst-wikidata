...
\set wd_input_table           wfwd.wd_match_localadmin
\set wof_input_table          wfwd.wof_match_localadmin

\set wd_wof_match             wfwd.wd_mlocaladmin_wof_match
\set wd_wof_match_agg         wfwd.wd_mlocaladmin_wof_match_agg
\set wd_wof_match_agg_sum     wfwd.wd_mlocaladmin_wof_match_agg_summary
\set wd_wof_match_notfound    wfwd.wd_mlocaladmin_wof_match_notfound
